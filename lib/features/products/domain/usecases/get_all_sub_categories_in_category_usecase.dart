...
class GetAllSubCategoriesInCategoryUseCase
    extends ParameterUseCase<List<SubCategory>, Category> {
  final BaseProductsRepository baseProductRepository;

  GetAllSubCategoriesInCategoryUseCase(this.baseProductRepository);

  @override
  Future<Either<Failure, List<SubCategory>>> call(Category params) async {
    return await baseProductRepository.getAllSubCategoriesInCategory(params);
  }
