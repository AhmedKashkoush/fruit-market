...
class RemoveFromFavouritesUseCase extends ParameterUseCase<Unit, Product> {
  final BaseProductsRepository baseProductRepository;

  RemoveFromFavouritesUseCase(this.baseProductRepository);

  @override
  Future<Either<Failure, Unit>> call(Product params) async {
    return await baseProductRepository.removeFromFavourites(params);
  }
